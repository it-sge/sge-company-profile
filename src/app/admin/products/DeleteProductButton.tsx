...
export default function DeleteProductButton({ id }: { id: number }) {
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={() => !loading && setIsOpen(false)} title="Hapus Produk">
        <p className="text-white/50 mb-6">Apakah Anda yakin ingin menghapus produk ini? Tindakan ini tidak dapat dibatalkan.</p>
